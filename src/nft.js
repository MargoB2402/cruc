...
export default function NFT() {
  ...
  async function callApi() {
    ...
    return (
          <h1 className="text-3xl">Wallet Not Connected or You don't have CRYPTORVERSE Utility NFT Collection</h1>)
    return (
                      ...
                      <div className="card nft-card mt-3 mb-3" key={i} >
                        ...
                        <div className="card-caption col-12 p-0">
                          <div className="card-body">
                            <h5 className="mb-0">CRYPTORVERSE Utility Collection #{nft.tokenId}</h5>
