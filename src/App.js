          ...
          <div class="container-fluid" style={{ fontFamily: "SF Pro Display" }}>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav me-auto mb-2 px-3 mb-md-0" style={{ fontSize: "25px" }}>
                ...
                <li class="nav-item">
                  <a class="nav-link" target="blank" href="https://cryptor.store/pages/cruc">About Collection</a>
                </li>
                <li class="nav-item">
        ...
        <div className='container container-style'>
          ...
          <form>
            <div className="row pt-3">
              ...
              <div className="row pt-3">
              <div>
                <h3 className="pt-2" style={{ fontWeight: "30" }}>Mint your Utility NFT with random discount:</h3>
              </div>
              <h6>- from $22 to $30</h6>
              <h6>- some with special prize 100 CRYPTOR</h6>
              <h6>- some with special NFT from NEW Collection</h6>
              </div>
            ...
            <div className="row px-2 pb-2 row-style">
              <div className="col ">
                <Button className="button-style" onClick={mint0} style={{ border: "0.2px", borderRadius: "14px", boxShadow: "1px 1px 5px #000000" }}>
                  <img src={"cryptor-coin.png"} width="70%" />
                </Button>
              </div>
              <div className="col">
                <Button className="button-style" onClick={mint7} style={{ border: "0.2px", borderRadius: "14px", boxShadow: "1px 1px 5px #000000" }}>
